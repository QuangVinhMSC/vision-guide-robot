...
def contourDetection(gray):
    ...
    cnt_template = np.load('/home/vinhdq/vision guide robot/temp_contour/selected_contour.npy', allow_pickle=True)
    cnt_inner = np.load('/home/vinhdq/vision guide robot/temp_contour/contour_inner.npy', allow_pickle=True)
    start_time = time.time()
